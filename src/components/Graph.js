...
const Graph = props => {
  ...
  const getData = () => {
    ...
    if(!startDate || !endDate || !startHour || !endHour){
      ...
      axios.get(`${baseURL}/get_kpis/1159/${startDate.toString()}/${endDate.toString()}/${startHour}/${endHour}`, {
      headers: {
    ...
    <div>
      <div className="inputs">
        ...
        <div className="container" style={{width: "10%"}}>
          ...
          <select defaultValue="HH" name="startHour" type="text" className="hour" onChange={handleInputs}>
        ...
        <div className="container" style={{width: "10%"}}>
          ...
          <select defaultValue="HH" name="endHour" type="text" className="hour" onChange={handleInputs}>
            <option value="HH" disabled>HH</option>
            <option value="00">00</option>
            <option value="01">01</option>
            <option value="02">02</option>
